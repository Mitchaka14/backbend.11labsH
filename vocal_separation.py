...
# This long line separates the two functions above
####################################################################################################################

if __name__ == "__main__":
    input_audio_path = "Media/oAudio.mp3"
    vocal_audio_path = "Media"
    separate_vocals(input_audio_path, vocal_audio_path)
